...
LOGGER_ID = int(os.environ.get("LOGGER_ID", -1002111675614))   # ab sahi chalega
...
# ━━━━━━━━━━━━━❖ ➥ Cache Channel (optional – add if needed)
# Bot aur assistant dono is channel ke member hone chahiye
CACHE_CHANNEL_ID = int(getenv("CACHE_CHANNEL_ID", "-1004304730954"))   # pehle tha, wapas add kar diya
